      ...
      <div className="p-8 space-y-4 md:space-y-8 w-full lg:w-1/2">
        ...
        <motion.div
          ...
          <p>
            ...
            my life. After 8 years, I left the Marine Corps to pursue
            my passion: auto detailing.
          </p>
        </motion.div>
      </div>
      {/* <div>
      ...
      <div className="block h-full relative w-3/4 lg:1/2 z-10">
        <div
          ...
          <motion.div
            ...
            whileInView={{
              opacity: [
                0, 0.3, 0, 0.4, 0.1, 0.4, 0, 0.1, 0.3, 0.6, 0, 0.1,
                0.3, 0, 0.4, 0.1, 0.4, 0, 0.1, 0.3, 0.6, 1,
              ],
              transition: {
                duration: 1,
                type: "tween",
