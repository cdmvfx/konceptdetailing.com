...
const Testimonials = () => {
	...
	return (
		<div id="testimonials" className="px-8 py-16 text-center space-y-16 flex flex-col md:flex-row items-baseline leading-8 md:space-y-0 md:text-2xl md:leading-10">
			{
