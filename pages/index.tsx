...
import FrequentlyAskedQuestions from "../components/FrequencyAskedQuestions";
	...
	return (
		<>
			...
			<main className="relative overflow-hidden bg-[#111111]">
				...
				<Services />
				<Testimonials />
				<Gallery galleryPhotos={galleryPhotos as Array<string>} />
				<About />
...
export const getStaticProps: GetStaticProps = (async () => {
	...
	const galleryPhotos = galleryPhotosBlobs.blobs.map((image) => image.url);
